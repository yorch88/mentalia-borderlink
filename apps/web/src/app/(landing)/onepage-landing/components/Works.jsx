...
const stats= [
  { id, value, suffix: '+', label: 'Multiple Layouts' },
  { id, value, suffix: '+', label: 'Multi Languages' },
  { id, value, suffix: '+', label: 'Apps & Dashboard' },
  { id, value, suffix: '+', label: 'Multiple Modes' },
  { id, value, suffix: '+', label: 'Happy Customers' },
];
