import {LuCalendar1, LuCircuitBoard, LuClipboardList, LuCodesandbox, LuFileText, LuFingerprint, LuHouse, LuLayoutPanelLeft, LuLock, LuMail, LuMessagesSquare, LuMonitorDot, LuPackage, LuPictureInPicture2, LuShare2, LuShieldCheck, LuShoppingBag, LuSquareUserRound } from 'react-icons/lu';
...
},
{
  ...
  children: [{
    ...
    key: 'Verify Email',
    label: 'Verify Email',
    href: '/basic-verify-email'
  }, {
    key: 'Two Steps',
    label: 'Two Steps',
    href: '/basic-two-steps'
  }, {
    key: 'Logout',
    label: 'Logout',
    href: '/basic-logout'
    ...
    href: '/basic-reset-password'
  }, {
    key: 'Create Password',
    label: 'Create Password',
    href: '/basic-create-password'
  }]
}, {
  key: 'Cover Auth',
  label: 'Cover Auth',
  ...
  children: [{
    ...
    key: 'Verify Email',
    label: 'Verify Email',
    href: '/cover-verify-email'
  }, {
    key: 'Two Steps',
    label: 'Two Steps',
    href: '/cover-two-steps'
  }, {
    key: 'Logout',
    label: 'Logout',
    href: '/cover-logout'
  ...
  children: [{
    ...
    key: 'Verify Email',
    label: 'Verify Email',
    href: '/modern-verify-email'
  }, {
    key: 'Two Steps',
    label: 'Two Steps',
    href: '/modern-two-steps'
  }, {
    key: 'Logout',
    label: 'Logout',
    href: '/modern-logout'
